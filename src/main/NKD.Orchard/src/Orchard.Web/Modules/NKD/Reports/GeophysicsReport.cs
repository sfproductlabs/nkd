...
{
    public partial class GeophysicsReport : ReportHelper.TableReport
    {
        public GeophysicsReport()
        {
            InitializeComponent();
        }


        public GeophysicsReport(ReportHelper.ITableReportDataFiller filler)
            : base(filler)
        {
            InitializeComponent();
        ...
        public class DataProvider : ReportHelper.ITableReportDataFiller
        {
            ...
            {
                var o = (GeophysicsReportViewModel)_r;
